            ...
            <div className="w-[940px] max-w-[96vw] bg-white max-h-[92vh] rounded-2xl shadow-2xl flex flex-col overflow-hidden animate-zoom-in border border-slate-200" onClick={(e) => e.stopPropagation()}>
              ...
              <div className="p-6 flex-1 min-h-0 overflow-y-auto custom-scrollbar flex flex-col gap-5 text-xs bg-slate-50/30">
                ...
                {(() => {
                  ...
                  return (
                    <div className="bg-rose-50/90 border border-rose-200 rounded-xl p-4 flex flex-col gap-3 shadow-2xs shrink-0">
                ...
                <div className="bg-white border border-slate-200 rounded-xl overflow-hidden shadow-2xs flex flex-col shrink-0">
                      ...
                      <div className="p-4">
                        {amqpPropsMode === "table" && propEntries.length > 0 ? (
                          ...
                          <div className="relative rounded-xl overflow-hidden border border-slate-300 bg-slate-50 shadow-inner">
                            <pre
                              className="p-4 font-mono text-xs overflow-auto max-h-72 whitespace-pre-wrap break-all leading-relaxed custom-scrollbar select-all font-semibold m-0"
